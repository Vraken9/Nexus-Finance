...
void _accountModelSerialize(
  ...
  writer.writeBool(offsets[3], object.isBank);
  writer.writeBool(offsets[4], object.isCard);
  writer.writeBool(offsets[5], object.isCash);
  writer.writeBool(offsets[6], object.isDefault);
  writer.writeBool(offsets[7], object.isEwallet);
...
extension AccountModelQueryWhereSort
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhere> anyUuid() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhere> anyType() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
...
extension AccountModelQueryWhere
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidGreaterThan(
    String uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidLessThan(
    String uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidBetween(
    String lowerUuid,
    String upperUuid, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidStartsWith(
      String UuidPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'uuid',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'uuid',
        value: [''],
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> uuidIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeNotEqualTo(
      String type) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeGreaterThan(
    String type, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeLessThan(
    String type, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeBetween(
    String lowerType,
    String upperType, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeStartsWith(
      String TypePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'type',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
        value: [''],
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterWhereClause> typeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.lessThan(
...
extension AccountModelQueryFilter
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterFilterCondition> isBankEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isBank',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterFilterCondition> isCardEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isCard',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterFilterCondition> isCashEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isCash',
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterFilterCondition>
      isEwalletEqualTo(bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'isEwallet',
        value: value,
      ));
    });
  }
...
extension AccountModelQuerySortBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsBank() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBank', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsBankDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBank', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsCard() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCard', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsCardDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCard', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsCash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsCashDesc() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsEwallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEwallet', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> sortByIsEwalletDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEwallet', Sort.desc);
    });
  }
...
extension AccountModelQuerySortThenBy
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsBank() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBank', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsBankDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isBank', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsCard() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCard', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsCardDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCard', Sort.desc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsCash() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsCashDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isCash', Sort.desc);
    });
  }
  ...
  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsEwallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEwallet', Sort.asc);
    });
  }

  QueryBuilder<AccountModel, AccountModel, QAfterSortBy> thenByIsEwalletDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isEwallet', Sort.desc);
    });
  }
...
extension AccountModelQueryWhereDistinct
  ...
  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByIsBank() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isBank');
    });
  }

  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByIsCard() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isCard');
    });
  }

  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByIsCash() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, AccountModel, QDistinct> distinctByIsEwallet() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'isEwallet');
    });
  }
...
extension AccountModelQueryProperty
  ...
  QueryBuilder<AccountModel, bool, QQueryOperations> isBankProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isBank');
    });
  }

  QueryBuilder<AccountModel, bool, QQueryOperations> isCardProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isCard');
    });
  }

  QueryBuilder<AccountModel, bool, QQueryOperations> isCashProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<AccountModel, bool, QQueryOperations> isEwalletProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'isEwallet');
    });
  }
