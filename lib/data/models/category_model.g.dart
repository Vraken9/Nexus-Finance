...
extension CategoryModelQueryWhereSort
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhere> anyUuid() {
    return QueryBuilder.apply(this, (query) {
...
extension CategoryModelQueryWhere
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> uuidGreaterThan(
    String uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> uuidLessThan(
    String uuid, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> uuidBetween(
    String lowerUuid,
    String upperUuid, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> uuidStartsWith(
      String UuidPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'uuid',
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> uuidIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'uuid',
        value: [''],
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> typeStartsWith(
      String TypePrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'type',
  ...
  QueryBuilder<CategoryModel, CategoryModel, QAfterWhereClause> typeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'type',
        value: [''],
